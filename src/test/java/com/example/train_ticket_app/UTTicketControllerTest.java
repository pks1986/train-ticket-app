...
import com.example.train_ticket_app.controller.TicketController;
...
public class UTTicketControllerTest {
    ...
    public void testGetReceiptNotFound() {
        when(ticketService.getReceipt(any(String.class))).thenReturn(Optional.empty());
    ...
    public void testRemoveUserNotFound() {
        when(ticketService.removeUser(any(String.class))).thenReturn(false);
    ...
    public void testModifySeatBadRequest() {
        when(ticketService.modifySeat(any(String.class), any(String.class))).thenReturn(Optional.empty());
